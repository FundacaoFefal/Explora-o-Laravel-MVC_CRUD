...
<div class="edit-category">
    <h1 class="category-title">Category Details</h1> <!-- Updated title -->
            ...
            <div class="card-body">
                ...
                <form action="{{ url('categories/'.$category->id.'/edit') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <br>
                        <input type="text" name="name" id="name" value="{{ $category->name }}" style="margin: 0 auto; text-align: center; display: block;" readonly/>
                    ...
                    <div class="mb-3">
                        ...
                        <br>
                        <textarea name="description" id="description" class="form-control" rows="3" style="margin: 0 auto; text-align: center; display: block;" readonly>{{ $category->description }}</textarea>
